 ...
 * @link HolidayTest
 */
readonly class TranslationKeys
{
    final public const ALL_SAINTS_DAY = 'ALL_SAINTS_DAY';
    final public const ASSUMPTION_OF_MARY = 'ASSUMPTION_OF_MARY';
    final public const AUGSBURG_PEACE_FESTIVAL = 'AUGSBURG_PEACE_FESTIVAL';
    final public const BIBLICAL_MAGI = 'BIBLICAL_MAGI';
    ...
    final public const FEAST_OF_CORPUS_CHRISTI = 'FEAST_OF_CORPUS_CHRISTI';
